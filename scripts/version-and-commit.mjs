...
if (args.length > 0 && !args[0].startsWith('--')) {
  ...
  console.error('    node scripts/version-and-commit.mjs --mode changeset [--js-root <path>]')
  ...
  console.error('  node scripts/version-and-commit.mjs --mode changeset --js-root js')
  process.exit(1)
}
